...
console.log(deleteOne("booleano", true));
...
console.log(isThisAnEmail("me@gmail.com"));
/* ESERCIZIO 7
...
const isTodayMyBirthday = function () {
  ...
  const birthday = new Date(today.getFullYear(), 6, 14);
...
const myObj = { name: "Mario", age: 30, city: "Roma" };
console.log(deleteProp(myObj, "city"));
/* ESERCIZIO 12
...
*/
const selectAllTdElements = function () {
...
*/
const printTdElementsText = function () {
  const tdElements = document.getElementsByTagName("td");
...
const addNewListItem = function () {
  ...
  newListItem.innerText = "residenza";
